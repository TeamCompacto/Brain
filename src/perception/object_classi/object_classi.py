...
# futtatni : python3 detect.py --weights yolov7-tiny.pt --conf 0.4 --img-size 320 --source 0
...
class ObjectDetectionProcess(WorkerProcess):
    ...
    def _init_socket(self):
        ...
        clientSocket.connect(("0.0.0.0",2023));     
        # Send data to server
        data = "Hello Server!";
        clientSocket.send(data.encode());

    def _init_threads(self):
        decTh = Thread(name='DecisionMakingThread', target=self._detect, )
