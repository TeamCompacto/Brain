...
# ha rossz az imageio, akkor : sudo pip3 install imageio==2.4.1
...
# Ez a webcamos resz, csak akkor futtassuk, ha van webcam, s ut is, amit felismerjen, maskepp hiba, s nem megy
